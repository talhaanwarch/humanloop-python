...
class CreateEvaluationRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["config_id", "evaluator_ids", "testset_id", "provider_api_keys", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["config_id", "evaluator_ids", "testset_id", "provider_api_keys", ], str]):
