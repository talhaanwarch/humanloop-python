# humanloop.model.completion_experiment_request.CompletionExperimentRequest
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Completion request for a specific experiment. | 
