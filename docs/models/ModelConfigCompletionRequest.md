# humanloop.model.model_config_completion_request.ModelConfigCompletionRequest
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Completion model config request | 

### Dictionary Keys
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**model** | str,  | str,  | The model instance used. E.g. text-davinci-002. | 
**prompt_template** | str,  | str,  | Prompt template that will take your specified inputs to form your final request to the model. Input variables within the prompt template should be specified with syntax: {{INPUT_NAME}}. | 
