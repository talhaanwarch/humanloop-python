# humanloop.model.completion_model_config_request.CompletionModelConfigRequest
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Completion request for a specific model config. | 
